        ...
        >
          ...
          <div className="text-center mb-10">
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-extrabold font-[family-name:var(--font-heading)] text-white text-balance">
              ...
              <span className="text-white/75">negocio</span>?
            </h2>
            <p className="mt-4 text-lg text-white/80 leading-relaxed">
              Contanos qué procesos querés automatizar y te proponemos una solución concreta.
          ...
          {submitState === "success" ? (
            <div className="flex flex-col items-center gap-4 py-10 text-center">
              ...
              <p className="text-white/80 max-w-sm">
                Te respondemos a la brevedad. ¡Gracias por contactarte con Figuriz!
              </p>
            </div>
          ) : (
            /* Form */
